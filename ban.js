    ...
    window.onload = function blacklist_json () {
        ...
        function showData(data) {
            ...
            for (let i = 0; i < json.blacklist.length; i++) {
                ...
                var blacklist = json.blacklist[i].id
